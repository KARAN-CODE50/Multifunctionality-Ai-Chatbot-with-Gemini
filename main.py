...
# This is to set the streamlit page settings 
st.set_page_config(
    page_title="AI Saarthi",
    page_icon="🤖",
    layout="centered",
)
...
with st.sidebar:
    ...
    selected = option_menu('Personalised AI ',
                           ['Chatbot',
                            'Image Captioning',
                            'Embed text',
                            'Ask me anything'],
